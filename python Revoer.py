...
#### LOGO ####
logo = """
\033[1;98m   REVOER REBORN
\033[1;91m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════════════¤═══¤═══¤═══║
\033[1;96m    ║✯ 𝕮𝖗𝖊𝖆𝖙𝖔𝖗  Koyuzu Alvin Revoer             ║    
\033[1;98m    ║✯ Website ☪ nhentai.net            ║  
\033[1;96m    ║✯ Gunakan Script Dengan Bijak!! ║
\033[1;91m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════════════¤═══¤═══¤═══║"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
\033[1;95m____██▄▄█▄█▄█▒▒▒█▄█▄█▄▄██ 
"""
jalan("\033[1;92m              Revoer X Reborn



CorrectUsername = "Revoer"
CorrectPassword = "Reborn"
loop = 'true'
while (loop == 'true'):
...
def login():
	...
	try:
		...
		print logo
		print 42*"\033[1;96m="
		print('\033[1;96m[⚡] \x1b[1;91m───Login Pakai Akun Baru───\x1b[1;93m[⚡]' )
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.nhentai.net')
...
def menu():
	...
	print "\033[1;36;40m      ╚═════════════════════════════════╝"
	print "    \033[1;32;40m[Type1] \033[1;33;40m‹•.•›Start♥Crack"	
...
def super():
	...
	os.system('clear')
	print logo
	print "     \033[1;97m-•◈•-\033[1;91m> \033[1;91m1.\x1b[1;95m>_<Clone List Teman."
	print "     \033[1;97m-•◈•-\033[1;91m> \033[1;91m2.\x1b[1;95m>_<Crack Publik Akun ."
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•══════•◈•\033[1;91m|Revoer|\033[1;97m•◈•══════•◈•"
		...
		print "\033[1;92m•◈•══════••◈•\033[1;91mAlvin\033[1;95m•◈•══════••◈•"
		try:
	...
	jalan('           \033[1;91m start cloning tunggu...')
	print  "  \033[1;92m ●══════════════════◄►══════════════════●" 
	...
	print "  \033[1;91m«---•◈•---Developed By Koyuzu Alvin Revoer--•◈•---»" #Dev:Alvin Revoer
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 Revoer.py)↩\033[1;97m....'
...
_______¶¶¶_________¶______¶_________¶¶¶______
         ...
         Checkpoint ID Buka Setelah 7 Hari
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m .... Koyuzu Alvin Revoer....... \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91m Koyuzu Alvin Revoer"""
